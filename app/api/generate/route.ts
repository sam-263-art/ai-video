...
export async function POST(req: Request) {
  try {
    ...
    const MODE_MAP: Record<number, string> = {
      1: "text2video", 2: "img2video", 3: "firstlast", 4: "talking", 5: "product", 6: "extend"
    };
    const mode = MODE_MAP[body.t] || "text2video";
